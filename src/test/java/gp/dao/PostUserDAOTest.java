...
public class PostUserDAOTest extends AbstractJUnit4SpringContextTests{

	Principal principal = Users.PESUOD_USER;
	ServiceContext svcctx ;
	@Autowired
    private PostUserDAO orgdao;
	...
	public void test() throws Exception{
		...
		InfoId<Long> id = idService.generateId(IdKey.POST_USER,Long.class);
		...
		info.setPostId(123l);
		info.setAttendee("ssslsl");
		info.setGlobalAccount("gac001");
		...
		PostUserInfo info2= orgdao.query( id);
