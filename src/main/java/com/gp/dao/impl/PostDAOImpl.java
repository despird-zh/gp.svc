...
public class PostDAOImpl extends DAOSupport implements PostDAO{
	...
	@Autowired
	public PostDAOImpl(@Qualifier(DataSourceHolder.DATA_SRC)DataSource dataSource) {
	...
	public int create( PostInfo info) {
		...
		SQL.append("insert into gp_posts (")
			...
			.append("upvote_count,post_time,scope,classification,")
		...
		Object[] params = new Object[]{
				...
				info.getUpvoteCount(),info.getPostDate(),info.getScope(),info.getClassification(),
